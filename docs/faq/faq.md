...
- Become somewhat familiar with how deej works. A great way to do this is to read the [how it works](https://github.com/Red-M/ReeeMiks#how-it-works) section in the main README, or to simply read through most of this FAQ :)
...
If your serial monitor appears to be similar to this, and behaves correctly when you move all of your pots, you're good to go! Close the serial monitor, and proceed to [download and set up](https://github.com/Red-M/ReeeMiks/releases/latest) deej's desktop client and its config.yaml file.
...
> You can check out a complete list of configuration file options [here](https://github.com/Red-M/ReeeMiks#slider-mapping-configuration).
...
Keep in mind that this is a bit more complicated. You'll need to start by grabbing the debug executable of deej (`deej-debug.exe`) from the [releases page](https://github.com/Red-M/ReeeMiks/releases) and downloading it to the same location where your deej.exe and config.yaml are:
