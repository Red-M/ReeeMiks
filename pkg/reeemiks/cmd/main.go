...
import (
	...
	"github.com/Red-M/ReeeMiks/pkg/reeemiks"
)
...
func main() {
	...
	logger, err := reeemiks.NewLogger(buildType)
	if err != nil {
	...
	// create the reeemiks instance
	d, err := reeemiks.NewReeemiks(logger, verbose)
	if err != nil {
		named.Fatalw("Failed to create reeemiks object", "error", err)
	}
	...
	if err = d.Initialize(); err != nil {
		named.Fatalw("Failed to initialize reeemiks", "error", err)
	}
}
