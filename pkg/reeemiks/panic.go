...
const (
	crashlogFilename        = "reeemiks-crash-%s.log"
	crashlogTimestampFormat = "2006.01.02-15.04.05"

	crashMessage = `-----------------------------------------------------------------
                        reeemiks crashlog
-----------------------------------------------------------------
Unfortunately, reeemiks has crashed. This really shouldn't happen!
If you've just encountered this, please contact @omriharel and attach this error log.
You can also join the reeemiks Discord server at https://discord.gg/nf88NJu.
-----------------------------------------------------------------
Time: %s
Panic occurred: %s
Stack trace:
...
func (d *Reeemiks) recoverFromPanic() {
	r := recover()
